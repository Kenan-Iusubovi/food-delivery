...
(
    ...
    `take_address` VARCHAR
(
    45
) NOT NULL,
    `bring_address` VARCHAR
(
    45
) NOT NULL,
...
(
    ...
    UNIQUE INDEX `order_number_UNIQUE`
(
    `order_number`
),
...
(
    ...
    INDEX `idx_food_spots_menu`
(
    `menu_id`
),
    INDEX `idx_food_spots_order`
(
    `order_id`
),
...
(
    ...
    UNIQUE INDEX `business_license_UNIQUE`
(
    `business_license`
),
    UNIQUE INDEX `id_UNIQUE`
