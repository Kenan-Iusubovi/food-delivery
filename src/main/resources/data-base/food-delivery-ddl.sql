...
CREATE TABLE food_spots (
                            ...
                            CONSTRAINT fk_fs_owner FOREIGN KEY (food_spot_owner_id)
...
CREATE TABLE menus (
                       ...
                       CONSTRAINT fk_menu_fs FOREIGN KEY (food_spot_id)
...
CREATE TABLE orders (
                        ...
                        CONSTRAINT fk_orders_fs FOREIGN KEY (food_spot_id)
                            REFERENCES food_spots(id)
);
...
CREATE TABLE menus_has_products (
                                    ...
                                    CONSTRAINT fk_mhp_menu FOREIGN KEY (menu_id)
                                        REFERENCES menus(id)
                                        ON DELETE CASCADE,
                                    CONSTRAINT fk_mhp_product FOREIGN KEY (product_id)
...
CREATE TABLE products_has_orders (
                                     ...
                                     CONSTRAINT fk_pho_product FOREIGN KEY (product_id)
                                         REFERENCES products(id)
                                         ON DELETE CASCADE,
                                     CONSTRAINT fk_pho_order FOREIGN KEY (order_id)
